/**
 * Minimal ABIs — only what this app reads/writes on-chain, hand-written from the
 * verified pons v2 source (github.com/ponsdotdev/ponsfamily, contractsV2/src/v2).
 */
...
/** pons v2 launch factory — the LaunchedToken record. */
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: "phase", type: "uint8" }, // 0 NotGraduated, 1 Swept, 2 PoolCreated, 3 Rescued
...
/** pons v2 per-token bonding curve. */
